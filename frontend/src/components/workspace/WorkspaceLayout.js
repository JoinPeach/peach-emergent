        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-1" data-testid="collaborative-avatars">
            ...
            <div className="relative group">
              ...
              {/* Tooltip - Next to this specific avatar */}
              <div className="absolute -top-8 -left-2 bg-gray-900 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap shadow-lg" style={{ zIndex: 9999 }}>
                Sarah Chen
              </div>
            </div>
